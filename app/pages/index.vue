<template>
  <div>
    <UPageHero
      title="The high-speed security auditor that hardens your codebase"
      description="Automated scanning, hardcoded secret detection, and real-time risk visualization to secure your application in every commit"
      :links="[
        {
          label: 'Get started',
